...
import { layerOf, type Board, type Owner, type MatchSpec } from '../transfer/model.ts';
...
export function mountShapes(canvas: HTMLCanvasElement, initial: { spec: MatchSpec; seed: string; skill: Skill }): Mounted {
